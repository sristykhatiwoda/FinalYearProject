...
namespace OnlineCourse.DapperObject
{
    public class COU_CourseContentDA : I_COU_CourseContent
    {
        ...
        {
            var sqlQuery = "Insert into COU_CourseContent(CourseContentID,Video,[File],CourseID,UserID)" +
                "values(@CourseContentID,@Video,@File,@CourseID,@UserID)";
        ...
        {
            var sqlQuery = "Update COU_CourseContent set CourseContentID=@CourseContentID,Video=@Video,"
